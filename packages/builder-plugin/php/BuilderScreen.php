...
final class BuilderScreen
{
    ...
    private function getI18nStrings(): array
    {
        return [
            ...
            'library.newLayoutDescription' => __('Choose the type of page to generate. Each card creates a new draft page with a different starter, ready to refine in Blocky.', 'blocky'),
            'library.pageStarterLabel' => __('Page', 'blocky'),
            'library.pageStarterDescription' => __('A standard page to build freely.', 'blocky'),
            'library.pageStarterTitle' => __('New Blocky Page', 'blocky'),
            ...
            'library.newTemplatesDescription' => __('Create reusable parts or a full base template to connect to pages through Blocky WordPress blocks.', 'blocky'),
            ...
            'library.containsBlockyDocument' => __('Contains a Blocky document', 'blocky'),
            'library.noBlockyDocument' => __('WordPress page without a saved Blocky document', 'blocky'),
            'library.open' => __('Open', 'blocky'),
            'library.openInBlocky' => __('Open in Blocky', 'blocky'),
            ...
            'pages.builtWith' => __('Built with Blocky', 'blocky'),
            ...
            'inspector.loadingPages' => __('Loading Blocky pages…', 'blocky'),
            ...
            'inspector.blockyShort' => __('Blocky', 'blocky'),
            'inspector.wordpress' => __('WordPress', 'blocky'),
            'inspector.containsReusableBlockyDocument' => __('Contains a reusable Blocky document.', 'blocky'),
            'inspector.standardWordPressPageWithoutBlocky' => __('Standard WordPress page without a saved Blocky document.', 'blocky'),
            ...
            'inspector.loadingBlockyPages' => __('Loading Blocky pages...', 'blocky'),
            'inspector.pagesListedHint' => __('All pages are listed. Blocky pages are marked with a badge.', 'blocky'),
            ...
            'inspector.containsBlockyDocument' => __('Contains a Blocky document', 'blocky'),
