...
final class BuilderScreen
{
    ...
    private function getI18nStrings(): array
    {
        return [
            ...
            'library.newLayoutDescription' => __('Choose the type of page to generate. Each card creates a new draft page with a different starter, ready to refine in Blockwork.', 'blocky'),
            'library.pageStarterLabel' => __('Page', 'blocky'),
            'library.pageStarterDescription' => __('A standard page to build freely.', 'blocky'),
            'library.pageStarterTitle' => __('New Blockwork Page', 'blocky'),
            ...
            'library.newTemplatesDescription' => __('Create reusable parts or a full base template to connect to pages through Blockwork WordPress blocks.', 'blocky'),
            ...
            'library.containsBlockworkDocument' => __('Contains a Blockwork document', 'blocky'),
            'library.noBlockworkDocument' => __('WordPress page without a saved Blockwork document', 'blocky'),
            'library.open' => __('Open', 'blocky'),
            'library.openInBlockwork' => __('Open in Blockwork', 'blocky'),
            ...
            'pages.builtWith' => __('Built with Blockwork', 'blocky'),
            ...
            'inspector.loadingPages' => __('Loading Blockwork pages…', 'blocky'),
            ...
            'inspector.blockyShort' => __('Blockwork', 'blocky'),
            'inspector.wordpress' => __('WordPress', 'blocky'),
            'inspector.containsReusableBlockworkDocument' => __('Contains a reusable Blockwork document.', 'blocky'),
            'inspector.standardWordPressPageWithoutBlockwork' => __('Standard WordPress page without a saved Blockwork document.', 'blocky'),
            ...
            'inspector.loadingBlockworkPages' => __('Loading Blockwork pages...', 'blocky'),
            'inspector.pagesListedHint' => __('All pages are listed. Blockwork pages are marked with a badge.', 'blocky'),
            ...
            'inspector.containsBlockworkDocument' => __('Contains a Blockwork document', 'blocky'),
