...
final class BuilderScreen
{
    ...
    private function getI18nStrings(): array
    {
        return [
            ...
            'library.newLayoutDescription' => __('Choose the type of page to generate. Each card creates a new draft page with a different starter, ready to refine in Gennaker.', 'blocky'),
            'library.pageStarterLabel' => __('Page', 'blocky'),
            'library.pageStarterDescription' => __('A standard page to build freely.', 'blocky'),
            'library.pageStarterTitle' => __('New Gennaker Page', 'blocky'),
            ...
            'library.newTemplatesDescription' => __('Create reusable parts or a full base template to connect to pages through Gennaker WordPress blocks.', 'blocky'),
            ...
            'library.containsGennakerDocument' => __('Contains a Gennaker document', 'blocky'),
            'library.noGennakerDocument' => __('WordPress page without a saved Gennaker document', 'blocky'),
            'library.open' => __('Open', 'blocky'),
            'library.openInGennaker' => __('Open in Gennaker', 'blocky'),
            ...
            'inspector.loadingPages' => __('Loading Gennaker pages…', 'blocky'),
            ...
            'inspector.blockyShort' => __('Gennaker', 'blocky'),
            'inspector.wordpress' => __('WordPress', 'blocky'),
            'inspector.containsReusableGennakerDocument' => __('Contains a reusable Gennaker document.', 'blocky'),
            'inspector.standardWordPressPageWithoutGennaker' => __('Standard WordPress page without a saved Gennaker document.', 'blocky'),
            ...
            'inspector.loadingGennakerPages' => __('Loading Gennaker pages...', 'blocky'),
            'inspector.pagesListedHint' => __('All pages are listed. Gennaker pages are marked with a badge.', 'blocky'),
            ...
            'inspector.containsGennakerDocument' => __('Contains a Gennaker document', 'blocky'),
