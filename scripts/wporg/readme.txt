...
Gennaker channels the wind of Tailwind CSS into a fast, predictable page builder for WordPress.
...
* Convert existing Gutenberg posts to Gennaker pages with one click from the editor header.
...
2. Upload the gennaker-page-builder zip file and activate it.
3. Click the Gennaker menu in the admin sidebar, or open any post or page and choose "Edit with Gennaker".
...
Yes. Gennaker renders its pages independently of the active theme, using its own block markup and compiled stylesheets.
...
2. Pages list with the Gennaker badge identifying Gennaker-built content.
3. "Edit with Gennaker" button inside the WordPress editor to convert or open a document.
